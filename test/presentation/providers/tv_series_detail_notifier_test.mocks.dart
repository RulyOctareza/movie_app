...
// in expert_flutter_dicoding/test/presentation/providers/tv_series_detail_notifier_test.dart.
...
class MockGetTvSeriesDetail extends _i1.Mock implements _i4.GetTvSeriesDetail {
  ...
  @override
  _i5.Future<_i3.Either<_i6.Failure, _i7.TvSeries>> execute(int? id) =>
      (super.noSuchMethod(
        Invocation.method(
          #execute,
          [id],
        ),
        returnValue: _i5.Future<_i3.Either<_i6.Failure, _i7.TvSeries>>.value(
            _FakeEither_1<_i6.Failure, _i7.TvSeries>(
          this,
          Invocation.method(
            #execute,
            [id],
      ...
      ) as _i5.Future<_i3.Either<_i6.Failure, _i7.TvSeries>>);
}
